...
typedef long (PT_CALL* PF_PassThruOpen)(void *, unsigned long *);
...
typedef long (PT_CALL* PF_PassThruWriteMsgs)(unsigned long, void *, unsigned long *, unsigned long);
typedef long (PT_CALL* PF_PassThruStartPeriodicMsg)(unsigned long, void *, unsigned long *, unsigned long);
typedef long (PT_CALL* PF_PassThruStopPeriodicMsg)(unsigned long, unsigned long);
typedef long (PT_CALL* PF_PassThruStartMsgFilter)(unsigned long, unsigned long, void *, void *, void *, unsigned long *);
...
typedef long (PT_CALL* PF_PassThruIoctl)(unsigned long, unsigned long, void *, void *);

typedef void (*PF_StatusCallback)(char *,int,int);
...
#define ERR_INVALID_DEVICE_ID				0x20

// OP2.0 Tactrix specific
#define ERR_OEM_VOLTAGE_TOO_LOW				0x78
#define ERR_OEM_VOLTAGE_TOO_HIGH			0x77
